package com.example.coosincustomer.notification;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
      ...
      */
        ...
        if (remoteMessage.getData().get("title").trim().equals("CoOsin thông báo ["+currentUser+"]")){
            notificationManager.notify(notificationID, notificationBuilder.build());
        }
        if (remoteMessage.getData().get("title").trim().equals("CoOsin thanh toán ["+currentUser+"]")){
            notificationManager.notify(notificationID, notificationBuilder.build());
        }
    }
